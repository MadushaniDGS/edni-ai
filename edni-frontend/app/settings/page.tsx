...
export default function SettingsPage() {
  ...
  return (
    <div className="page">
      {/* Decorative stickers */}
      <div className="sticker stickerOne">✨</div>
      <div className="sticker stickerTwo">🌸</div>
      <div className="sticker stickerThree">💜</div>
      ...
      <header className="header">
        <div className="headerInner">
          <div>
            ...
            <p>
              Make Edni feel more comfortable for the way
              you learn.
            </p>
          </div>
        ...
        <div className="layout">
          ...
          <aside className="navigation">
            ...
            <div className="littleCard">
              ...
              <strong>Small changes matter</strong>

              <p>
                Personalize Edni so your learning space
                feels like yours.
              </p>
            </div>
          </aside>
              ...
              <div className="tabContent">
                ...
                <div className="displayGrid">
                    ...
                    <div className="optionRow">
                      {['light', 'dark'].map((theme) => (
                        <button
                          ...
                          className={`optionButton ${settings.theme === theme
                              ? 'selected'
                              : ''
                            }`}
                        >
                  ...
                  <div className="displayCard fullWidth">
                    ...
                    <p>
                      Adjust the text size across your
                      experience.
                    </p>
      ...
      {showDeleteConfirm && (
        <div className="modalOverlay">
          <div className="modal">
            <div className="modalSticker">🥺</div>

            <h2>Are you sure?</h2>

            <p>
              This will permanently delete your account
              and all associated data. This action cannot
              be undone.
            </p>
      ...
      <style jsx>{`
        * {
        ...
        .settingsBubble {
          ...
          box-shadow: 0 15px 35px rgba(39, 31, 105, 0.18);
        }
        ...
        .content {
          ...
          border-radius: 26px;
          box-shadow:
            0 8px 30px rgba(45, 33, 66, 0.055);
        }
        ...
        .toggleCard:hover {
          ...
          box-shadow: 0 8px 20px rgba(45, 33, 66, 0.05);
        }
